...
entity interrupt_controller is
    port(reset, clk : in std_logic;
        ...
        timer_int, peripheral_int : in std_logic;
...
begin
    ...
    any_interrupt_signal <= timer_int_buffer_out or peripheral_int_buffer_out;
    -- Encoder process
    process(timer_int_buffer_out, peripheral_int_buffer_out)
    begin
